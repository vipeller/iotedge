namespace Microsoft.Azure.Devices.Edge.Hub.MqttBrokerAdapter
{
    ...
    public class PocCloudConnectionProvider : ICloudConnectionProvider
    {
        PocCloudProxyDispatcher cloudProxyDispatcher;

        public PocCloudConnectionProvider(PocCloudProxyDispatcher cloudProxyDispatcher)
        {
        ...
        {
            var cloudProxy = new PocCloudProxy(identity, this.cloudProxyDispatcher);
            return Task.FromResult(new Try<ICloudConnection>(new PocCloudConnection(cloudProxy)));
        }
    }
}
